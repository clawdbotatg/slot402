...
export default function SlotPage() {
  ...
  // Reel 1: cherries(9) > oranges(8) > watermelons(7) > stars(6) > bells(5) > bars(4) > doublebars(3) > sevens(2) > baseeth(1) = 45 total
  const reel1Symbols = [
    "/slot/bar.png",
    "/slot/watermelon.png",
    "/slot/bell.png",
    ...
    "/slot/watermelon.png",
    "/slot/doublebar.png",
    "/slot/baseeth.png", // MOST RARE!
  ];

  // Reel 2: cherries(9) > oranges(8) > watermelons(7) > stars(6) > bells(5) > bars(4) > doublebars(3) > sevens(2) > baseeth(1) = 45 total
  const reel2Symbols = [
    "/slot/star.png",
    "/slot/doublebar.png",
    "/slot/watermelon.png",
  ...
  // Reel 3: cherries(9) > oranges(8) > watermelons(7) > stars(6) > bells(5) > bars(4) > doublebars(3) > sevens(2) > baseeth(1) = 45 total
  const reel3Symbols = [
    "/slot/bell.png",
    "/slot/bar.png",
    "/slot/star.png",
